...
import { freelancers } from "../workers"
...
import { CardFreelancer } from "./card-freelancer"
                ...
                <ResizablePanel defaultSize={defaultLayout[1]} minSize={30}>
                    <Tabs defaultValue="all">
                        ...
                        <div className="bg-background/95 p-4 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                            ...
                            <div className="flex flex-wrap gap-6 mt-6 h-[630px] overflow-auto">
                                {freelancers.map((freelancer: any, key: number) => {
                                    return (
                                        <CardFreelancer
                                            className=" w-[270px] h-[340px] cursor-pointer"
                                            key={key}
                                            img={freelancer.img}
                                            ...
                                            imagesExperiences={freelancer.works}
                                        />
                                    )
                                })}
                            </div>
